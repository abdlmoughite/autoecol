    ...
    <footer className="footer">
      <div className="container-footer">
        <div className="child-footer one">
          <img
            src={`${process.env.PUBLIC_URL}/image/2-removebg-preview yahya.png`}
            alt="Maarofo|Logo"
          />
          <p>
            Apprenez à conduire avec nos instructeurs expérimentés dans une
            ambiance conviviale. Nous vous accompagnons tout au long de votre
            apprentissage, du code de la route à la conduite, pour obtenir votre
            permis en toute confiance.
          </p>
        </div>
        ...
        <div className="contact-info">
          ...
          <p>Adresse : 123 Rue Hay Mohamadi, Casablanca, Maroc</p>
          <p>Téléphone : +212 634 567 890</p>
          <p>
            Email :{" "}
            <Link to="mailto:elmaaroufisaid@autoecole.com">
              elmaaroufisaid@autoecole.com
            </Link>
          </p>
        </div>
        <div className="child-footer tree">
          <ul>
            <b>
              <li>Abonnez-vous</li>
              <li>
                <form action="https://formspree.io/f/xrbbrvkk" method="post">
      ...
      <div className="buttom-footer">
        <p>© 2025 El Maaroufi Said. Tous droits réservés.</p>
